...
const root = document.querySelector<HTMLDivElement>("#cli-root")!;
const titleEl = document.querySelector<HTMLSpanElement>("#cli-title")!;
const modeLabel = document.querySelector<HTMLSpanElement>("#cli-mode-label")!;
const termWrap = document.querySelector<HTMLDivElement>("#cli-term-wrap")!;
const termHost = document.querySelector<HTMLDivElement>("#cli-term")!;
const footL = document.querySelector<HTMLSpanElement>("#cli-foot-l")!;
const footM = document.querySelector<HTMLSpanElement>("#cli-foot-m")!;
const footHint = document.querySelector<HTMLSpanElement>("#cli-foot-r-hint")!;
const footR = document.querySelector<HTMLSpanElement>("#cli-foot-r")!;

const inp = document.querySelector<HTMLInputElement>("#cli-in")!;
const psEl = document.querySelector<HTMLSpanElement>("#cli-ps")!;
const echoEl = document.querySelector<HTMLSpanElement>("#cli-echo")!;
const sug = document.querySelector<HTMLDivElement>("#cli-sug")!;
const res = document.querySelector<HTMLDivElement>("#cli-res")!;
...
/** Post-command hold when the action steals focus (browser, Explorer, manager). */
...
function defaults() {
  showRows([
    { c: "profiles", d: "personal · work · uni · dev · ai · fun · folders · apps", cat: "profiles" },
...
function builtinPresets(home: string): Preset[] {
  return [
    { n: "mail", t: "web", d: "Gmail inbox", target: "https://mail.google.com/mail/u/0/#inbox", cat: "personal" },
    { n: "calendar", t: "web", d: "Google Calendar", target: "https://calendar.google.com/calendar/u/0/r", cat: "personal" },
    { n: "drive", t: "web", d: "Google Drive", target: "https://drive.google.com/drive/my-drive", cat: "personal" },
    { n: "maps", t: "web", d: "Google Maps", target: "https://maps.google.com/", cat: "personal" },
    { n: "translate", t: "web", d: "Google Translate", target: "https://translate.google.com/", cat: "personal" },
    { n: "whatsapp", t: "web", d: "WhatsApp Web", target: "https://web.whatsapp.com/", cat: "personal" },
    { n: "discord", t: "web", d: "Discord DMs", target: "https://discord.com/channels/@me", cat: "personal" },
    { n: "youtube", t: "web", d: "YouTube", target: "https://youtube.com", cat: "personal" },
    { n: "music", t: "web", d: "YouTube Music", target: "https://music.youtube.com/", cat: "personal", aliases: ["ytm", "youtubemusic"] },

    { n: "work", t: "web", d: "Gmail work profile", target: "https://mail.google.com/mail/u/1/#inbox", cat: "work" },
    { n: "workdrive", t: "web", d: "Google Drive (work)", target: "https://drive.google.com/drive/u/1/my-drive", cat: "work" },
    { n: "linkedin", t: "web", d: "LinkedIn feed", target: "https://www.linkedin.com/feed/", cat: "work" },
    { n: "notion", t: "web", d: "Notion", target: "https://www.notion.so/", cat: "work" },
    { n: "figma", t: "web", d: "Figma", target: "https://www.figma.com/", cat: "work" },
    { n: "langdock", t: "web", d: "Langdock chat", target: "https://app.langdock.com/chat", cat: "work" },

    { n: "uni", t: "web", d: "KIT Outlook", target: "https://owa.kit.edu/owa/#path=/mail", cat: "uni" },
    { n: "ilias", t: "web", d: "ILIAS dashboard", target: "https://ilias.studium.kit.edu/ilias.php?baseClass=ildashboardgui&cmd=show", cat: "uni" },
    { n: "campus", t: "web", d: "KIT Campus", target: "https://campus.studium.kit.edu/?login=1", cat: "uni" },

    { n: "github", t: "web", d: "GitHub", target: "https://github.com/", cat: "dev" },
    { n: "appwrite", t: "web", d: "Appwrite console", target: "https://cloud.appwrite.io/console", cat: "dev" },
    { n: "homeserver", t: "web", d: "Homeserver", target: "http://homeserver-laptop-mark.tail186368.ts.net/#/", cat: "dev" },
    { n: "chatgpt", t: "web", d: "ChatGPT", target: "https://chatgpt.com", cat: "ai" },
    { n: "gemini", t: "web", d: "Gemini", target: "https://gemini.google.com/app", cat: "ai" },
    { n: "huggingface", t: "web", d: "Hugging Face", target: "https://huggingface.co/", cat: "ai" },

    { n: "lichess", t: "web", d: "Lichess", target: "https://lichess.org/", cat: "fun" },
    ...
    { n: "widgets", t: "folder", d: "Widgets project", target: joinPath(home, "Documents\\Widgets"), cat: "folders" },
    { n: "desktop", t: "folder", d: "Desktop folder", target: joinPath(home, "Desktop"), cat: "folders" },
    { n: "pictures", t: "folder", d: "Pictures", target: joinPath(home, "Pictures"), cat: "folders" },

    { n: "cursor", t: "app", d: "Cursor editor", target: "cursor", cat: "apps" },
    { n: "code", t: "app", d: "Visual Studio Code", target: "code", cat: "apps", aliases: ["vscode"] },
    { n: "terminal", t: "app", d: "Windows Terminal", target: "wt", cat: "apps", aliases: ["wt"] },
    { n: "notepad", t: "app", d: "Notepad", target: "notepad", cat: "apps" },
    { n: "explorer", t: "app", d: "File Explorer", target: "explorer", cat: "apps" },
    { n: "calcapp", t: "app", d: "Calculator app", target: "calc", cat: "apps" },
    { n: "taskmgr", t: "app", d: "Task Manager", target: "taskmgr", cat: "apps" },
    { n: "settings", t: "app", d: "Windows Settings", target: "ms-settings:", cat: "apps" },
  ];
}

function applyCatalog(entries: CatalogEntry[]) {
  const builtins = builtinPresets(HOME || "C:\\");
...
function run(c: string) {
  ...
  switch (cmd) {
    ...
    case "help":
      setRes("out", "grammar — ? web · ?? files · = calc · term · profile names (uni, work, fun, apps, dev…)");
      return showRows([
        ...(sessionAlive
        ...
        { c: "mail · work · uni", d: "Gmail · work Gmail · KIT Outlook", cc: "mail" },
        { c: "start", d: "Start menu · installed apps", cc: "start" },
        { c: "showdesk", d: "Show desktop (taskbar Win+D)", cc: "showdesk" },
        { c: "desk", d: "toggle the HTML desktop (Documents\\Widgets\\desktop\\index.html)", cc: "desk" },
        { c: "hide <app>", d: "remove an auto-added app from the bar", cc: "hide " },
        { c: "presets <cat>", d: "browse uni · work · fun · apps …", cc: "presets " },
